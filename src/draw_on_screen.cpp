...
{
    cv::arrowedLine(img, cv::Point2d(ugv.x_position, ugv.y_position), cv::Point2d(ugv.x_position + 100, ugv.y_position), cv::Scalar(0, 0, 255), 5);
    cv::arrowedLine(img, cv::Point2d(ugv.x_position, ugv.y_position), cv::Point2d(ugv.x_position, ugv.y_position - 100), cv::Scalar(255, 0, 0), 5);
}
